...
set yrange [-10:10]                      # set y plot range
set xrange [0:511]                       # set x plot range
plot '../data/example.dat' using 1:4 with lines lt 1 lw 2 lc rgb '#888888' notitle,\
     '../data/example.dat' using 1:5 with lines lt 1 lw 2 lc rgb '#000088' notitle
...
plot '../data/example.dat' using 1:6 with lines lt 1 lw 3 lc rgb '#888888' notitle,\
     '../data/example.dat' using 1:7 with lines lt 1 lw 3 lc rgb '#000088' notitle
