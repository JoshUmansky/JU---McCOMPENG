...
class Client:
    ...
    def scan(self):
        try:
            ...
            self.client_udp_socket.sendto(scan_str.encode(MSG_ENCODING), ("255.255.255.255",UDP_PORT))
            ...
            print(respones_d.decode(MSG_ENCODING))
        except TimeoutError:
