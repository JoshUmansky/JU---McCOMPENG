...
cat ../data/iq_samples.raw | ./project 0 s | gnuplot -p -e "plot '-' with lines"
# cat ../data/iq_samples.raw | ./project 0 s > my_audio.bin

# cat my_audio.bin | aplay -f S16_LE -c 2 -r 48000